...
export declare class PetsController {
    ...
    create(ownerId: string, createPetDto: CreatePetDto, file?: Express.Multer.File): Promise<import("./schemas/pet.schema").Pet>;
    ...
    update(petId: string, updatePetDto: UpdatePetDto, file?: Express.Multer.File): Promise<import("./schemas/pet.schema").Pet>;
